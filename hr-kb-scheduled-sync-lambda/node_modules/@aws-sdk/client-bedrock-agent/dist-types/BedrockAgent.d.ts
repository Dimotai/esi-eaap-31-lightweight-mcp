...
import { AssociateAgentCollaboratorCommandInput, AssociateAgentCollaboratorCommandOutput } from "./commands/AssociateAgentCollaboratorCommand";
...
import { DeleteKnowledgeBaseDocumentsCommandInput, DeleteKnowledgeBaseDocumentsCommandOutput } from "./commands/DeleteKnowledgeBaseDocumentsCommand";
import { DeletePromptCommandInput, DeletePromptCommandOutput } from "./commands/DeletePromptCommand";
import { DisassociateAgentCollaboratorCommandInput, DisassociateAgentCollaboratorCommandOutput } from "./commands/DisassociateAgentCollaboratorCommand";
...
import { GetAgentCollaboratorCommandInput, GetAgentCollaboratorCommandOutput } from "./commands/GetAgentCollaboratorCommand";
...
import { GetKnowledgeBaseDocumentsCommandInput, GetKnowledgeBaseDocumentsCommandOutput } from "./commands/GetKnowledgeBaseDocumentsCommand";
import { GetPromptCommandInput, GetPromptCommandOutput } from "./commands/GetPromptCommand";
import { IngestKnowledgeBaseDocumentsCommandInput, IngestKnowledgeBaseDocumentsCommandOutput } from "./commands/IngestKnowledgeBaseDocumentsCommand";
...
import { ListAgentCollaboratorsCommandInput, ListAgentCollaboratorsCommandOutput } from "./commands/ListAgentCollaboratorsCommand";
...
import { ListKnowledgeBaseDocumentsCommandInput, ListKnowledgeBaseDocumentsCommandOutput } from "./commands/ListKnowledgeBaseDocumentsCommand";
...
import { UpdateAgentCollaboratorCommandInput, UpdateAgentCollaboratorCommandOutput } from "./commands/UpdateAgentCollaboratorCommand";
...
import { ValidateFlowDefinitionCommandInput, ValidateFlowDefinitionCommandOutput } from "./commands/ValidateFlowDefinitionCommand";
export interface BedrockAgent {
    /**
     * @see {@link AssociateAgentCollaboratorCommand}
     */
    associateAgentCollaborator(args: AssociateAgentCollaboratorCommandInput, options?: __HttpHandlerOptions): Promise<AssociateAgentCollaboratorCommandOutput>;
    associateAgentCollaborator(args: AssociateAgentCollaboratorCommandInput, cb: (err: any, data?: AssociateAgentCollaboratorCommandOutput) => void): void;
    associateAgentCollaborator(args: AssociateAgentCollaboratorCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AssociateAgentCollaboratorCommandOutput) => void): void;
    /**
     ...
     */
    deleteKnowledgeBaseDocuments(args: DeleteKnowledgeBaseDocumentsCommandInput, options?: __HttpHandlerOptions): Promise<DeleteKnowledgeBaseDocumentsCommandOutput>;
    deleteKnowledgeBaseDocuments(args: DeleteKnowledgeBaseDocumentsCommandInput, cb: (err: any, data?: DeleteKnowledgeBaseDocumentsCommandOutput) => void): void;
    deleteKnowledgeBaseDocuments(args: DeleteKnowledgeBaseDocumentsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteKnowledgeBaseDocumentsCommandOutput) => void): void;
    /**
     ...
     */
    disassociateAgentCollaborator(args: DisassociateAgentCollaboratorCommandInput, options?: __HttpHandlerOptions): Promise<DisassociateAgentCollaboratorCommandOutput>;
    disassociateAgentCollaborator(args: DisassociateAgentCollaboratorCommandInput, cb: (err: any, data?: DisassociateAgentCollaboratorCommandOutput) => void): void;
    disassociateAgentCollaborator(args: DisassociateAgentCollaboratorCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisassociateAgentCollaboratorCommandOutput) => void): void;
    /**
     ...
     */
    getAgentCollaborator(args: GetAgentCollaboratorCommandInput, options?: __HttpHandlerOptions): Promise<GetAgentCollaboratorCommandOutput>;
    getAgentCollaborator(args: GetAgentCollaboratorCommandInput, cb: (err: any, data?: GetAgentCollaboratorCommandOutput) => void): void;
    getAgentCollaborator(args: GetAgentCollaboratorCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetAgentCollaboratorCommandOutput) => void): void;
    /**
     ...
     */
    getKnowledgeBaseDocuments(args: GetKnowledgeBaseDocumentsCommandInput, options?: __HttpHandlerOptions): Promise<GetKnowledgeBaseDocumentsCommandOutput>;
    getKnowledgeBaseDocuments(args: GetKnowledgeBaseDocumentsCommandInput, cb: (err: any, data?: GetKnowledgeBaseDocumentsCommandOutput) => void): void;
    getKnowledgeBaseDocuments(args: GetKnowledgeBaseDocumentsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetKnowledgeBaseDocumentsCommandOutput) => void): void;
    /**
     ...
     */
    ingestKnowledgeBaseDocuments(args: IngestKnowledgeBaseDocumentsCommandInput, options?: __HttpHandlerOptions): Promise<IngestKnowledgeBaseDocumentsCommandOutput>;
    ingestKnowledgeBaseDocuments(args: IngestKnowledgeBaseDocumentsCommandInput, cb: (err: any, data?: IngestKnowledgeBaseDocumentsCommandOutput) => void): void;
    ingestKnowledgeBaseDocuments(args: IngestKnowledgeBaseDocumentsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: IngestKnowledgeBaseDocumentsCommandOutput) => void): void;
    /**
     ...
     */
    listAgentCollaborators(args: ListAgentCollaboratorsCommandInput, options?: __HttpHandlerOptions): Promise<ListAgentCollaboratorsCommandOutput>;
    listAgentCollaborators(args: ListAgentCollaboratorsCommandInput, cb: (err: any, data?: ListAgentCollaboratorsCommandOutput) => void): void;
    listAgentCollaborators(args: ListAgentCollaboratorsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListAgentCollaboratorsCommandOutput) => void): void;
    /**
     ...
     */
    listKnowledgeBaseDocuments(args: ListKnowledgeBaseDocumentsCommandInput, options?: __HttpHandlerOptions): Promise<ListKnowledgeBaseDocumentsCommandOutput>;
    listKnowledgeBaseDocuments(args: ListKnowledgeBaseDocumentsCommandInput, cb: (err: any, data?: ListKnowledgeBaseDocumentsCommandOutput) => void): void;
    listKnowledgeBaseDocuments(args: ListKnowledgeBaseDocumentsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListKnowledgeBaseDocumentsCommandOutput) => void): void;
    /**
     ...
     */
    stopIngestionJob(args: StopIngestionJobCommandInput, options?: __HttpHandlerOptions): Promise<StopIngestionJobCommandOutput>;
    stopIngestionJob(args: StopIngestionJobCommandInput, cb: (err: any, data?: StopIngestionJobCommandOutput) => void): void;
    stopIngestionJob(args: StopIngestionJobCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: StopIngestionJobCommandOutput) => void): void;
    /**
     ...
     */
    updateAgentCollaborator(args: UpdateAgentCollaboratorCommandInput, options?: __HttpHandlerOptions): Promise<UpdateAgentCollaboratorCommandOutput>;
    updateAgentCollaborator(args: UpdateAgentCollaboratorCommandInput, cb: (err: any, data?: UpdateAgentCollaboratorCommandOutput) => void): void;
    updateAgentCollaborator(args: UpdateAgentCollaboratorCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateAgentCollaboratorCommandOutput) => void): void;
    /**
     ...
     */
    validateFlowDefinition(args: ValidateFlowDefinitionCommandInput, options?: __HttpHandlerOptions): Promise<ValidateFlowDefinitionCommandOutput>;
    validateFlowDefinition(args: ValidateFlowDefinitionCommandInput, cb: (err: any, data?: ValidateFlowDefinitionCommandOutput) => void): void;
    validateFlowDefinition(args: ValidateFlowDefinitionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ValidateFlowDefinitionCommandOutput) => void): void;
}
/**
